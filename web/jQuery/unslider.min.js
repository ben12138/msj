(function (c, b) {
    var a = function () {
        ...
        d.init = function (i, j) {
            ...
            d.li = d.ul.find(d.o.item).each(function (l) {
                var n = c(this), m = n.outerWidth(), k = n.outerHeight();
                if (m > d.max[0]) {
                    d.max[0] = m
                }
                if (k > d.max[1]) {
            ...
            var j = d.o, h = d.ul, g = d.li, f = g.length;
            d.i = 0;
            ...
            setTimeout(function () {
                if (j.delay | 0) {
                    d.play();
                    if (j.pause) {
                        i.on("mouseover mouseout", function (k) {
                            d.stop();
                            k.type == "mouseout" && d.play()
                        })
                    }
                }
            }, j.init | 0);
            if (j.keys) {
                c(document).keydown(function (l) {
                    var k = l.which;
                    if (k == 37) {
                        d.prev()
                    } else {
            ...
            if (j.fluid) {
                c(window).resize(function () {
                    ...
                    d.r = setTimeout(function () {
                        var l = {height: g.eq(d.i).outerHeight()}, k = i.outerWidth();
                        h.css(l);
            ...
            if (c.event.special.swipe || c.Event("swipe")) {
                i.on("swipeleft swiperight swipeLeft swipeRight", function (k) {
                    k.type.toLowerCase() == "swipeleft" ? d.next() : d.prev()
                })
            }
            return d
        };
        d.to = function (j, q) {
            ...
            var f = d.o, g = d.el, m = d.ul, p = d.li, k = d.i, l = p.eq(j);
            ...
            l = p.eq(j);
            var h = q ? 5 : f.speed | 0, n = f.easing, i = {height: l.outerHeight()};
            if (!m.queue("fx").length) {
                g.find(".dot").eq(j).addClass("active").siblings().removeClass("active");
                g.animate(i, h, n) && m.animate(c.extend({left: "-" + j + "00%"}, i), h, n, function (o) {
                    d.i = j;
        ...
        function e(f, g) {
            if (f == "dot") {
                g = '<ol class="dots">';
                c.each(d.li, function (h) {
                    g += '<li class="' + (h == d.i ? f + " active" : f) + '">' + (++h) + "</li>"
                });
                g += "</ol>"
            } else {
                g = '<div class="';
    ...
    c.fn.unslider = function (e) {
        ...
        return this.each(function (g) {
            var i = c(this), h = "unslider" + (d > 1 ? "-" + (++g) : ""), f = (new a).init(i, e);
